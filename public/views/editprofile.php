...
<head>
    ...
    <title>MedIA — Editar Perfil</title>
    ...
    <style>
        ...
        .hint { font-size: .8rem; color: #999; margin-top: .2rem; }
    </style>
</head>
...
<main class="card">
    ...
    <form method="POST" action="/editprofile">
        ...
        <input id="username" name="username" type="text" required
               value="<?= htmlspecialchars($_SESSION['token']['username'] ?? '') ?>"
               placeholder="O teu nome de utilizador">

        <label for="password">Nova Password <span style="color:#999; font-weight:400;">(opcional)</span></label>
        <input id="password" name="password" type="password"
               placeholder="Deixa em branco para não alterar">
        <p class="hint"><i class="bi bi-info-circle"></i> Só preenche se quiseres mudar a password.</p>
    ...
    <div class="text-center mt-3" style="font-size:.9rem;">
        <a class="link-media" href="/"><i class="bi bi-house me-1"></i>Voltar à página inicial</a>
    </div>
</main>
